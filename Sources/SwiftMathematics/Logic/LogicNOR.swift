...
public extension Bool {
    ...
    ///
    /// The logical NOR operator (`↓`) combines two Boolean values and returns
    /// `true` if neither of the values is `true`. If at least one value is
    ...
    ///
    /// - Returns: The logical NOR of `p` and `q`.
